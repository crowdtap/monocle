...
RUN apt-get update -qq && apt-get install -y build-essential libpq-dev postgresql-client wget ruby-dev zlib1g-dev liblzma-dev libgmp3-dev software-properties-common vim
